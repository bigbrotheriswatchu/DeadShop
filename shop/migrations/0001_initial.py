# Generated by Django 2.2 on 2020-03-15 19:45
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('collection_name', models.CharField(db_index=True, max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shirt_image', models.ImageField(blank=True, upload_to='image')),
                ('size', models.CharField(max_length=10)),
                ('composition', models.CharField(max_length=50)),
                ('collection', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='shop.Collection', verbose_name='Категория')),
            ],
            options={
                'verbose_name': 'Майка',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('t_shirt', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='shop.Tshirt')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nmb', models.IntegerField(default=1)),
                ('price_per_item', models.DecimalField(decimal_places=2, default=123, max_digits=10)),
                ('total_price', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
                ('is_active', models.BooleanField(default=True)),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
